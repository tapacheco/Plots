...
def plot_color_magnitude_diagram(ms_color, ms_mag, \
    ...
    axt[0,0].scatter(bhb_color['F275W_F336W'],bhb_mag['F275W'], marker='o', s=5, c='#33BBEE')#purple
    axt[0,0].scatter(ehb_color['F275W_F336W'],ehb_mag['F275W'], marker='s', s=5, c='#EE3377')#magenta
    ...
    axt[0,1].scatter(bhb_color['F336W_F438W'],bhb_mag['F336W'], marker='o', s=5, c='#33BBEE')#cyan
    axt[0,1].scatter(ehb_color['F336W_F438W'],ehb_mag['F336W'], marker='s', s=5, c='#EE3377')#magenta
    ...
    axt[1,0].scatter(bhb_color['F438W_F606W'],bhb_mag['F438W'], marker='o', s=5, c='#33BBEE')#cyan
    axt[1,0].scatter(ehb_color['F438W_F606W'],ehb_mag['F438W'], marker='s', s=5, c='#EE3377')#magenta
    ...
    axt[1,1].scatter(bhb_color['F606W_F814W'],bhb_mag['F606W'], marker='o', s=5, c='#33BBEE')#cyan
    axt[1,1].scatter(ehb_color['F606W_F814W'],ehb_mag['F606W'], marker='s', s=5, c='#EE3377')#magenta
