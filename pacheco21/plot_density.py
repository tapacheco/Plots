...
def fig_density(nlte_t10000K_g45, nlte_t10000K_g55, nlte_t10000K_g65, \
    ...
    ax1.plot(np.log10(nlte_t10000K_g45['deepPoints']), np.log10(nlte_t10000K_g45['eletronic_density']), '.', c='#FAC13B', label=r"",linewidth=3)
    ax1.plot(np.log10(nlte_t10000K_g55['deepPoints']), np.log10(nlte_t10000K_g55['eletronic_density']), '-.',c='#FAC13B', label=r"",linewidth=3)
    ax1.plot(np.log10(nlte_t10000K_g65['deepPoints']), np.log10(nlte_t10000K_g65['eletronic_density']), '--',c='#FAC13B', label=r"",linewidth=3)
    ...
    ax3.plot(np.log10(nlte_t10000K_g45['deepPoints']), np.log10(nlte_t10000K_g45['mass_density']), '.', c='#FAC13B', label=r"",linewidth=3)
    ax3.plot(np.log10(nlte_t10000K_g55['deepPoints']), np.log10(nlte_t10000K_g55['mass_density']), '-.',c='#FAC13B', label="",linewidth=3)
    ax3.plot(np.log10(nlte_t10000K_g65['deepPoints']), np.log10(nlte_t10000K_g65['mass_density']), '--',c='#FAC13B', label="",linewidth=3)
    ...
    ax2.plot(np.log10(nlte_t65000K_g45['deepPoints']), np.log10(nlte_t65000K_g45['eletronic_density']), '.', c='#000004', label=r"log $g$ = 4.5",linewidth=3)
    ax2.plot(np.log10(nlte_t65000K_g55['deepPoints']), np.log10(nlte_t65000K_g55['eletronic_density']), '-.',c='#000004', label=r"log $g$ = 5.5",linewidth=3)
    ...
    ax4.plot(np.log10(nlte_t65000K_g45['deepPoints']), np.log10(nlte_t65000K_g45['mass_density']), '.', c='#000004', label=r"",linewidth=3)
    ax4.plot(np.log10(nlte_t65000K_g55['deepPoints']), np.log10(nlte_t65000K_g55['mass_density']), '-.',c='#000004', label="",linewidth=3)
    ax4.plot(np.log10(nlte_t65000K_g65['deepPoints']), np.log10(nlte_t65000K_g65['mass_density']), '--',c='#000004', label="",linewidth=3)
