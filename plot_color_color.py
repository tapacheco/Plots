...
def plot_color_color_diagram(ms_color, \
    ...
    axs[0,0].scatter( ms_color['F275W_F438W'], ms_color['F275W_F336W'], marker='o', s=10, c='#EE7733',label='MS')
    axs[0,0].scatter( gb_color['F275W_F438W'], gb_color['F275W_F336W'], marker='o', s=10, c='#009988',label='gb')
    axs[0,0].scatter(rhb_color['F275W_F438W'],rhb_color['F275W_F336W'], marker='o', s=10, c='#CC3311',label='RC')
    axs[0,0].scatter( bs_color['F275W_F438W'], bs_color['F275W_F336W'], marker='o', s=10, c='#0077BB',label='bs')
    axs[0,0].scatter(bhb_color['F275W_F438W'],bhb_color['F275W_F336W'], marker='o', s=10, c='#33BBEE',label='HB')
    axs[0,0].scatter(ehb_color['F275W_F438W'],ehb_color['F275W_F336W'], marker='o', s=10, c='#EE3377',label='EHB')
    ...
    axs[0,1].scatter( ms_color['F275W_F814W'], ms_color['F438W_F814W'], marker='o', s=10, c='#EE7733',label='MS')
    axs[0,1].scatter( gb_color['F275W_F814W'], gb_color['F438W_F814W'], marker='o', s=10, c='#009988',label='gb')
    axs[0,1].scatter(rhb_color['F275W_F814W'],rhb_color['F438W_F814W'], marker='o', s=10, c='#CC3311',label='RC')
    axs[0,1].scatter( bs_color['F275W_F814W'], bs_color['F438W_F814W'], marker='o', s=10, c='#0077BB',label='bs')
    axs[0,1].scatter(bhb_color['F275W_F814W'],bhb_color['F438W_F814W'], marker='o', s=10, c='#33BBEE',label='HB')
    axs[0,1].scatter(ehb_color['F275W_F814W'],ehb_color['F438W_F814W'], marker='o', s=10, c='#EE3377',label='EHB')
    ...
    axs[1,0].scatter( ms_color['F336W_F606W'], ms_color['F606W_F814W'], marker='o', s=10, c='#EE7733',label='MS')
    axs[1,0].scatter( gb_color['F336W_F606W'], gb_color['F606W_F814W'], marker='o', s=10, c='#009988',label='gb')
    axs[1,0].scatter(rhb_color['F336W_F606W'],rhb_color['F606W_F814W'], marker='o', s=10, c='#CC3311',label='RC')
    axs[1,0].scatter( bs_color['F336W_F606W'], bs_color['F606W_F814W'], marker='o', s=10, c='#0077BB',label='bs')
    axs[1,0].scatter(bhb_color['F336W_F606W'],bhb_color['F606W_F814W'], marker='o', s=10, c='#33BBEE',label='HB')
    axs[1,0].scatter(ehb_color['F336W_F606W'],ehb_color['F606W_F814W'], marker='o', s=10, c='#EE3377',label='EHB')
    ...
    axs[1,1].scatter( ms_color['F275W_F606W'], ms_color['F438W_F606W'], marker='o', s=10, c='#EE7733',label='MS')
    axs[1,1].scatter( gb_color['F275W_F606W'], gb_color['F438W_F606W'], marker='o', s=10, c='#009988',label='gb')
    axs[1,1].scatter(rhb_color['F275W_F606W'],rhb_color['F438W_F606W'], marker='o', s=10, c='#CC3311',label='RC')
    axs[1,1].scatter( bs_color['F275W_F606W'], bs_color['F438W_F606W'], marker='o', s=10, c='#0077BB',label='bs')
    axs[1,1].scatter(bhb_color['F275W_F606W'],bhb_color['F438W_F606W'], marker='o', s=10, c='#33BBEE',label='HB')
    axs[1,1].scatter(ehb_color['F275W_F606W'],ehb_color['F438W_F606W'], marker='o', s=10, c='#EE3377',label='EHB')
    ...
    axs[2,0].scatter( ms_color['F336W_F814W'], ms_color['F336W_F438W'], marker='o', s=10, c='#EE7733',label='MS')
    axs[2,0].scatter( gb_color['F336W_F814W'], gb_color['F336W_F438W'], marker='o', s=10, c='#009988',label='gb')
    axs[2,0].scatter(rhb_color['F336W_F814W'],rhb_color['F336W_F438W'], marker='o', s=10, c='#CC3311',label='RC')
    axs[2,0].scatter( bs_color['F336W_F814W'], bs_color['F336W_F438W'], marker='o', s=10, c='#0077BB',label='bs')
    axs[2,0].scatter(bhb_color['F336W_F814W'],bhb_color['F336W_F438W'], marker='o', s=10, c='#33BBEE',label='HB')
    axs[2,0].scatter(ehb_color['F336W_F814W'],ehb_color['F336W_F438W'], marker='o', s=10, c='#EE3377',label='EHB')
